...
from .model import CTXDocument, KeyValue, NumberedItem, PlainLine, Section
from .serializer import _serialize_header_iter, serialize_section
...
def _extract_section_text(section: Section) -> str:
    ...
    for child in section.children:
        ...
        elif isinstance(child, PlainLine) or isinstance(child, NumberedItem):
