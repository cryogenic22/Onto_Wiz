...
class _Parser:
    ...
    def _error(self, msg: str, line: int | None = None) -> ParseError:
    ...
    def parse(self) -> CTXDocument:
        ...
        body: tuple[Section | BodyElement, ...] = ()
    ...
    def _parse_kv_token(self, token: str, lineno: int) -> KeyValue | None:
        idx = token.find(":")
        if idx <= 0:
            return None
    ...
    def _parse_body(
        ...
        """
        elements: list[Section | BodyElement] = []
